...
namespace wardrobe.Controllers
{
    ...
    {
        private OutfitsEntities db = new OutfitsEntities();
        ...
        public ActionResult Create([Bind(Include = "OutfitID,OutfitName,OutfitPhoto,TopID,BottomID,ShoeID,AccessoryID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,OutfitName,OutfitPhoto,TopID,BottomID,ShoeID,AccessoryID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
